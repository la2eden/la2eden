...
import com.la2eden.gameserver.model.actor.instance.L2PetInstance;
import com.la2eden.gameserver.model.actor.instance.L2ServitorInstance;
import com.la2eden.gameserver.model.actor.stat.PcStat;
import com.la2eden.gameserver.model.actor.stat.SummonStat;
import com.la2eden.gameserver.model.actor.status.PcStatus;
import com.la2eden.gameserver.model.actor.status.SummonStatus;
...
import static com.la2eden.gameserver.util.Util.formatAdena;
...
public class NpcBuffer extends Quest
{
    ...
    {
        String MAIN_HTML_MESSAGE = "<html noscrollbar><body><table cellpadding=0 cellspacing=0 width=292 height=358 background=\"L2UI_CH3.refinewnd_back_Pattern\"><tr><td valign=\"top\" align=\"center\"><table width=280><tr><td align=center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32></td></tr></center></table><br>";
        String MESSAGE = "";
        int td = 0;
        final String[] TRS =
                {
        ...
        if (ENABLE_BUFF_SECTION)
        {
            if (ENABLE_BUFFS)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_buffs 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
            if (ENABLE_RESIST)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Resist\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_resists 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
            if (ENABLE_SONGS)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Songs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_songs 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
            if (ENABLE_DANCES)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Dances\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_dances 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
            if (ENABLE_CHANTS)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Chants\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_chants 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
            if (ENABLE_SPECIAL)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Special\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_special 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
            if (ENABLE_OTHERS)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"Others\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_others 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }
        }
        ...
        if (ENABLE_CUBIC)
        {
            ...
            MESSAGE += TRS[td] + "<button value=\"Cubics\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect view_cubic 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
            td += 2;
        }

        if (MESSAGE.length() > 0)
        {
            MAIN_HTML_MESSAGE += "<br1><table width=260><tr><td align=center><img src=\"L2UI.SquareGray\" width=250 height=1></td></tr><tr><td height=5></td></tr></table><BR1><table cellspacing=0 cellpadding=0>" + MESSAGE + "</table>";
            MESSAGE = "";
            td = 0;
        }
        ...
        if (ENABLE_BUFF_SET)
        {
            ...
            MESSAGE += TRS[td] + "<button value=\"" + bottonA + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " castBuffSet 0 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
            td += 2;
        }
        ...
        if (ENABLE_HEAL)
        {
            ...
            MESSAGE += TRS[td] + "<button value=\"" + bottonB + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " heal 0 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
            td += 2;
        }
        ...
        if (ENABLE_BUFF_REMOVE)
        {
            ...
            MESSAGE += TRS[td] + "<button value=\"" + bottonC + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " removeBuffs 0 0 0\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
            td += 2;
        }

        if (MESSAGE.length() > 0)
        {
            MAIN_HTML_MESSAGE += "<table width=260><tr><td align=center><img src=\"L2UI.SquareGray\" width=250 height=1></td></tr><tr><td height=5></td></tr></table><BR1><table cellspacing=0 cellpadding=0>" + MESSAGE + "</table>";
            MESSAGE = "";
            td = 0;
        }
    ...
    private String generateScheme(QuestState st)
    {
        ...
        HTML += "<table width=260><tr><td align=center><img src=\"L2UI.SquareGray\" width=250 height=1></td></tr><tr><td height=5></td></tr></table><BR1><table cellspacing=0 cellpadding=0>";
        if (schemeName.size() > 0)
        {
            ...
            for (int i = 0; i < schemeName.size(); ++i)
            {
                ...
                MESSAGE += TRS[td] + "<button value=\"" + schemeName.get(i) + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " cast " + schemeId.get(i) + " x x\" width=130 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">" + TRS[td + 1];
                td += 2;
            }

            if (MESSAGE.length() > 0)
            {
                HTML += "<table>" + MESSAGE + "</table><table width=260><tr><td align=center><img src=\"L2UI.SquareGray\" width=250 height=1></td></tr><tr><td height=5></td></tr></table>";
            }
        }

        if (schemeName.size() < SCHEMES_PER_PLAYER)
        {
            HTML += "<BR1><table><tr><td><button value=\"Create\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " create_1 x x x\" width=80 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td>";
        }
        else
        {
        ...
        if (schemeName.size() > 0)
        {
            HTML += "<td><button value=\"Edit\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_1 x x x\" width=85 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td><td><button value=\"Delete\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete_1 x x x\" width=85 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></tr></table>";
        }
        else
        {
            HTML += "</tr></table>";
    ...
    private String showText(QuestState st, String type, String text, boolean buttonEnabled, String buttonName, String location)
    {
        ...
        if (buttonEnabled)
        {
            MESSAGE += "<button value=\"" + buttonName + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect " + location + " 0 0\" width=100 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
    ...
    {
        return "<html><head><title>" + TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br><br>You MUST seprerate new words with a dot (.)<br><br>Scheme name: <edit var=\"name\" width=100><br><br><button value=\"Create Scheme\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " create $name no_name x x\" width=200 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
    }
    ...
    private String deleteScheme(L2PcInstance player)
    {
        ...
        try (Connection con = DatabaseFactory.getInstance().getConnection())
        {
            ...
            while (rss.next())
            {
                HTML += "<button value=\"" + rss.getString("scheme_name") + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete_c " + rss.getString("id") + " " + rss.getString("scheme_name") + " x\" width=200 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
            }
            statement.close();
            rss.close();
        }
        ...
        HTML += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
        return HTML;
    }
    ...
    private String editScheme(L2PcInstance player)
    {
        ...
        try (Connection con = DatabaseFactory.getInstance().getConnection())
        {
            ...
            while (rss.next())
            {
                ...
                HTML += "<button value=\"" + name + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_select " + id + " x x\" width=200 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
            }
            statement.close();
            rss.close();
        }
    ...
    private String getOptionList(String scheme)
    {
        ...
        {
            HTML += "<button value=\"Add buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_1 " + scheme + " 1 x\" width=200 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (bcount > 0)
        {
            HTML += "<button value=\"Remove buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_2 " + scheme + " 1 x\" width=200 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        HTML += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_1 0 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
        return HTML;
    }
    ...
    private String buildHtml(String buffType)
    {
        ...
        else
        {
            ...
            for (String buff : availableBuffs)
            {
                ...
                name = name.replace("+", " ");
                HTML_MESSAGE += "<tr><td>" + getSkillIconHtml(id, level) + "</td><td><button value=\"" + name + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " giveBuffs " + id + " " + level + " " + buffType + "\" width=190 height=32 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></tr>";
            }
            HTML_MESSAGE += "</table>";
        }

        HTML_MESSAGE += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
        return HTML_MESSAGE;
    }
    ...
    private String viewAllSchemeBuffs(String scheme, String page, String addOrRemove)
    {
        ...
        for (int ii = 1; ii <= pc; ++ii)
        {
            ...
            {
                HTML_MESSAGE += "<td width=" + width + "><button value=\"" + pageName + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_1 " + scheme + " " + ii + " x\" width=" + width + " height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td>";
            }
            else if (addOrRemove.equals("remove"))
            {
                HTML_MESSAGE += "<td width=" + width + "><button value=\"" + pageName + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_2 " + scheme + " " + ii + " x\" width=" + width + " height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td>";
            }
            else if (DEBUG)
            {
                throw new RuntimeException();
        ...
        for (int i = start; i < end; ++i)
        {
            ...
            if (addOrRemove.equals("add"))
            {
                if (!isUsed(scheme, id, level))
                {
                    ...
                    HTML_MESSAGE += "<tr><td width=35>" + getSkillIconHtml(id, level) + "</td><td fixwidth=170>" + name + "</td><td><button value=\"Add\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " add_buff " + scheme + "_" + id + "_" + level + " " + page + " " + TOTAL_BUFF + "\" width=65 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></tr></table>";
                    k += 1;
                }
            }
            else if (addOrRemove.equals("remove"))
            {
                ...
                HTML_MESSAGE += "<tr><td width=35>" + getSkillIconHtml(id, level) + "</td><td fixwidth=170>" + name + "</td><td><button value=\"Remove\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " remove_buff " + scheme + "_" + id + "_" + level + " " + page + " " + TOTAL_BUFF + "\" width=65 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></table>";
                k += 1;
            }
        }
        HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_select " + scheme + " x x\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
        return HTML_MESSAGE;
    }
    ...
    private String viewAllBuffTypes()
    {
        ...
        if (ENABLE_BUFFS)
        {
            HTML_MESSAGE += "<button value=\"Buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list buff Buffs 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_RESIST)
        {
            HTML_MESSAGE += "<button value=\"Resist Buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list resist Resists 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_SONGS)
        {
            HTML_MESSAGE += "<button value=\"Songs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list song Songs 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_DANCES)
        {
            HTML_MESSAGE += "<button value=\"Dances\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list dance Dances 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_CHANTS)
        {
            HTML_MESSAGE += "<button value=\"Chants\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list chant Chants 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_SPECIAL)
        {
            HTML_MESSAGE += "<button value=\"Special Buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list special Special_Buffs 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_OTHERS)
        {
            HTML_MESSAGE += "<button value=\"Others Buffs\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list others Others_Buffs 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_CUBIC)
        {
            HTML_MESSAGE += "<button value=\"Cubics\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list cubic cubic_Buffs 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\">";
        }
        if (ENABLE_BUFF_SET)
        {
            HTML_MESSAGE += "<button value=\"Buff Sets\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list set Buff_Sets 1\" width=200 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br>";
        }
        HTML_MESSAGE += "<button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
        return HTML_MESSAGE;
    }
    ...
    private String viewAllBuffs(String type, String typeName, String page)
    {
        ...
        for (int ii = 1; ii <= pc; ++ii)
        {
            ...
            {
                HTML_MESSAGE += "<td width=" + width + "><button value=\"" + pageName + "" + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_buff_list " + type + " " + typeName + " " + ii + "\" width=" + width + " height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td>";
            }
        }
        ...
        for (int i = start; i < end; ++i)
        {
            ...
            if (type.equals("set"))
            {
                ...
                HTML_MESSAGE += "<tr><td fixwidth=145>" + name + "</td><td width=70><combobox var=\"newSet" + i + "\" width=70 " + listOrder + "></td><td width=50><button value=\"Update\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " changeBuffSet " + skillPos + " $newSet" + i + " " + page + "\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></tr>";
            }
            else
            {
                ...
                if (usable == 1)
                {
                    HTML_MESSAGE += "<button value=\"Disable\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " editSelectedBuff " + skillPos + " 0-" + page + " " + type + "\" width=80 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></tr>";
                }
                else if (usable == 0)
                {
                    HTML_MESSAGE += "<button value=\"Enable\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " editSelectedBuff " + skillPos + " 1-" + page + " " + type + "\" width=80 height=22 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"></td></tr>";
                }
            }
            HTML_MESSAGE += "</table>";
        }
        HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect manage_buffs 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
        return HTML_MESSAGE;
    }
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
    {
        ...
        switch (eventParam0)
        {
            ...
            case "delete_c":
                return "<html><head><title>" + TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Do you really want to delete '" + eventParam2 + "' scheme?<br><br><button value=\"Yes\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete " + eventParam1 + " x x\" width=50 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><button value=\"No\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete_1 x x x\" width=50 height=27 back=\"L2UI_CT1.Button_DF_Large\" fore=\"L2UI_CT1.Button_DF_Large\"><br><font color=303030>" + TITLE_NAME + "</font></center></body></html>";
