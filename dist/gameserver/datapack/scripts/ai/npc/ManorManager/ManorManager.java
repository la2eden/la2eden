...
import com.la2eden.gameserver.network.serverpackets.BuyListSeed;
import com.la2eden.gameserver.network.serverpackets.ExShowCropInfo;
import com.la2eden.gameserver.network.serverpackets.ExShowManorDefaultInfo;
import com.la2eden.gameserver.network.serverpackets.ExShowProcureCropDetail;
import com.la2eden.gameserver.network.serverpackets.ExShowSeedInfo;
import com.la2eden.gameserver.network.serverpackets.ExShowSellCropList;
...
public final class ManorManager extends AbstractNpcAI
{
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		return getHtm(player.getHtmlPrefix(), "./datapack/html/npcdefault.htm");
	}
