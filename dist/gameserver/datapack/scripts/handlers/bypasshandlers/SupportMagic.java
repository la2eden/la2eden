...
public class SupportMagic implements IBypassHandler
{
	...
	private static void makeSupportMagic(L2PcInstance player, L2Npc npc, boolean isSummon)
	{
		...
		{
			npc.showChatWindow(player, "./datapack/html/default/SupportMagicNoSummon.htm");
			return;
		}
		else if (level > HIGHEST_LEVEL)
		{
			npc.showChatWindow(player, "./datapack/html/default/SupportMagicHighLevel.htm");
			return;
		}
		else if (level < LOWEST_LEVEL)
		{
			npc.showChatWindow(player, "./datapack/html/default/SupportMagicLowLevel.htm");
			return;
		}
