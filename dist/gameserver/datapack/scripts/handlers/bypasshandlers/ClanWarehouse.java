...
import com.la2eden.gameserver.model.actor.instance.L2ClanHallManagerInstance;
import com.la2eden.gameserver.model.actor.instance.L2PcInstance;
import com.la2eden.gameserver.model.actor.instance.L2WarehouseInstance;
		...
		try
		{
			if (command.toLowerCase().startsWith(COMMANDS[0])) // WithdrawC
			{
				if (Config.L2JMOD_ENABLE_WAREHOUSESORTING_CLAN)
				{
					...
					msg.setFile(activeChar.getHtmlPrefix(), "./datapack/html/mods/WhSortedC.htm");
