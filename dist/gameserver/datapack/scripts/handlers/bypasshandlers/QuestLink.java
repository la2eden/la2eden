...
public class QuestLink implements IBypassHandler
{
	 ...
	 * <b><u>Actions</u>:</b><br>
	 * <ul>
	 * <li>Get the text of the quest state in the folder datapack/scripts/quests/questId/stateId.htm</li>
	 * <li>Send a Server->Client NpcHtmlMessage containing the text of the L2NpcInstance to the L2PcInstance</li>
			...
			if (qs == null)
			{
				if ((q.getId() >= 1) && (q.getId() < 20000))
				{
					...
					if (player.getAllActiveQuests().size() > 40)
					{
						...
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fullquest.html");
