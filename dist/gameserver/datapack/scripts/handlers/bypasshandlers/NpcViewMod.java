...
import com.la2eden.gameserver.model.drops.GeneralDropItem;
import com.la2eden.gameserver.model.drops.GroupedGeneralDropItem;
import com.la2eden.gameserver.model.drops.IDropItem;
...
public class NpcViewMod implements IBypassHandler
{
	...
	public static void sendNpcView(L2PcInstance activeChar, L2Npc npc)
	{
		...
		html.setFile(activeChar.getHtmlPrefix(), "./datapack/html/mods/NpcView/Info.htm");
	...
	private static void sendNpcDropList(L2PcInstance activeChar, L2Npc npc, DropListScope dropListScope, int page)
	{
		...
		String html = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/mods/NpcView/DropList.htm");
		if (html == null)
		{
