...
import com.la2eden.gameserver.model.zone.form.ZoneNPoly;
import com.la2eden.gameserver.network.serverpackets.ConfirmDlg;
import com.la2eden.gameserver.network.serverpackets.ExServerPrimitive;
import com.la2eden.gameserver.network.serverpackets.ExShowTerritory;
...
public class AdminZones extends AbstractNpcAI implements IAdminCommandHandler
{
	...
	private void buildZonesEditorWindow(L2PcInstance activeChar)
	{
		...
		msg.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/zone_editor.htm");
	...
	{
		final NpcHtmlMessage msg = new NpcHtmlMessage(0, 1);
		msg.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/zone_editor_create.htm");
		final ZoneNodeHolder holder = _zones.computeIfAbsent(activeChar.getObjectId(), key -> new ZoneNodeHolder());
