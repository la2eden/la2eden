...
import com.la2eden.gameserver.data.sql.impl.AnnouncementsTable;
			...
			case "admin_announces":
			{
				...
				switch (subCmd)
				{
					case "add":
					{
						if (!st.hasMoreTokens())
						{
							final String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/announces-add.htm");
					...
					case "edit":
					{
						...
						if (!st.hasMoreTokens())
						{
							String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/announces-edit.htm");
					...
					case "show":
					{
						...
						if (announce != null)
						{
							String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/announces-show.htm");
							final String announcementId = "" + announce.getId();
							final String announcementType = announce.getType().name();
							String announcementInital = "0";
							String announcementDelay = "0";
					...
					case "list":
					{
						...
						String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/announces-list.htm");
