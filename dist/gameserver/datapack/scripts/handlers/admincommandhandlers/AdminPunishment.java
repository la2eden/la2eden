	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		switch (cmd)
		{
			case "admin_punishment":
			{
				if (!st.hasMoreTokens())
				{
					String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/punishment.htm");
					if (content != null)
					{
				...
				else
				{
					...
					switch (subcmd)
					{
						case "info":
						{
							...
							String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/punishment-info.htm");
							if (content != null)
							{
						...
						case "player":
						{
							...
							String content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/punishment-player.htm");
							if (content != null)
							{
