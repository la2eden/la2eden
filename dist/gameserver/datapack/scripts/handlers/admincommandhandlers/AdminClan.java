	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		switch (cmd)
		{
			case "admin_clan_info":
			{
				...
				html.setHtml(HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/claninfo.htm"));
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(0, 1);
				html.setHtml(HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/clanchanges.htm"));
