...
public class AdminSiege implements IAdminCommandHandler
{
	...
	private void showCastleSelectPage(L2PcInstance activeChar)
	{
		...
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/castles.htm");
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/castle.htm");
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/castlesiegetime.htm");
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/clanhall.htm");
