...
import com.la2eden.gameserver.model.PageResult;
...
import com.la2eden.gameserver.network.serverpackets.GMViewItemList;
...
import com.la2eden.gameserver.util.HtmlUtil;
...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	private void listCharacters(L2PcInstance activeChar, int page)
	{
		...
		html.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/charlist.htm");
	...
	private void gatherCharacterInfo(L2PcInstance activeChar, L2PcInstance player, String filename)
	{
		...
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/" + filename);
	...
	private void findCharacter(L2PcInstance activeChar, String CharacterToFind)
	{
		...
		String name;
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/charfind.htm");
	...
	private void findCharactersPerIp(L2PcInstance activeChar, String IpAdress) throws IllegalArgumentException
	{
		...
		final StringBuilder replyMSG = new StringBuilder(1000);
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/ipfind.htm");
		for (L2PcInstance player : L2World.getInstance().getPlayersSortedBy(Comparator.comparingLong(L2PcInstance::getUptime)))
		{
	...
	private void findCharactersPerAccount(L2PcInstance activeChar, String characterName) throws IllegalArgumentException
	{
		...
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/accountinfo.htm");
		adminReply.replace("%account%", player.getAccountName());
	...
	private void findDualbox(L2PcInstance activeChar, int multibox)
	{
		...
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/dualbox.htm");
	...
	{
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/petinfo.htm");
	...
	private void gatherPartyInfo(L2PcInstance target, L2PcInstance activeChar)
	{
		boolean color = true;
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(activeChar.getHtmlPrefix(), "./datapack/html/admin/partyinfo.htm");
