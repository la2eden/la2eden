...
import com.la2eden.gameserver.model.zone.type.L2NoRestartZone;
		...
		switch (actualCommand.toLowerCase())
		{
			case "admin_grandboss":
			{
				...
				else
				{
					...
					html.setHtml(HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/grandboss.htm"));
		...
		if (Arrays.asList(ANTHARAS, VALAKAS, BAIUM, QUEENANT, ORFEN, CORE).contains(grandBossId))
		{
			...
			switch (grandBossId)
			{
				case ANTHARAS:
				{
					...
					htmlPatch = "./datapack/html/admin/grandboss_antharas.htm";
					break;
				}
				case VALAKAS:
				{
					htmlPatch = "./datapack/html/admin/grandboss_valakas.htm";
					break;
				}
				case BAIUM:
				{
					bossZone = ZoneManager.getInstance().getZoneById(BAIUM_ZONE, L2NoRestartZone.class);
					htmlPatch = "./datapack/html/admin/grandboss_baium.htm";
					break;
				}
				case QUEENANT:
				{
					htmlPatch = "./datapack/html/admin/grandboss_queenant.htm";
					break;
				}
				case ORFEN:
				{
					htmlPatch = "./datapack/html/admin/grandboss_orfen.htm";
					break;
				}
				case CORE:
				{
					htmlPatch = "./datapack/html/admin/grandboss_core.htm";
					break;
				}
			}
