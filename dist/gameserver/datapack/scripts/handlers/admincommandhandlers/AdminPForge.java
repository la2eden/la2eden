...
import com.la2eden.commons.mmocore.NioNetStringBuffer;
...
import com.la2eden.gameserver.network.clientpackets.L2GameClientPacket;
import com.la2eden.gameserver.network.serverpackets.AdminForgePacket;
...
public final class AdminPForge implements IAdminCommandHandler
{
	...
	private void showValuesPage(L2PcInstance activeChar, String[] opCodes, String format)
	{
		...
		String valuesHtml = HtmCache.getInstance().getHtmForce(activeChar.getHtmlPrefix(), "./datapack/html/admin/pforge/values.htm");
		if (opCodes.length == 3)
		{
		...
		else
		{
			...
			final String editorTemplate = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/admin/pforge/inc/editor.htm");
