...
public class Lang implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, L2PcInstance activeChar, String params)
	{
		...
		if (params == null)
		{
			...
			msg.setFile(activeChar.getHtmlPrefix(), "./datapack/html/mods/Lang/LanguageSelect.htm");
		...
		if (st.hasMoreTokens())
		{
			...
			{
				msg.setFile(activeChar.getHtmlPrefix(), "./datapack/html/mods/Lang/Ok.htm");
				activeChar.sendPacket(msg);
				return true;
			}
			msg.setFile(activeChar.getHtmlPrefix(), "./datapack/html/mods/Lang/Error.htm");
			activeChar.sendPacket(msg);
			return true;
		}
		return false;
