...
public class FavoriteBoard implements IParseBoardHandler
{
	...
	public boolean parseCommunityBoardCommand(String command, L2PcInstance activeChar)
	{
		...
		{
			// Load Favorite links
			final String list = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/CommunityBoard/favorite_list.html");
				...
				PreparedStatement ps = con.prepareStatement(SELECT_FAVORITES))
			{
				...
				String html = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/CommunityBoard/favorite.html");
