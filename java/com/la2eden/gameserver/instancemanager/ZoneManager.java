...
import com.la2eden.gameserver.model.zone.L2ZoneForm;
import com.la2eden.gameserver.model.zone.L2ZoneRespawn;
import com.la2eden.gameserver.model.zone.L2ZoneType;
import com.la2eden.gameserver.model.zone.form.ZoneCuboid;
import com.la2eden.gameserver.model.zone.form.ZoneCylinder;
import com.la2eden.gameserver.model.zone.form.ZoneNPoly;
import com.la2eden.gameserver.model.zone.type.L2ArenaZone;
...
public final class ZoneManager implements IXmlReader
{
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("com.la2eden.gameserver.model.zone.type.L2" + zoneType);
	...
	public final void load()
	{
		...
		parseDatapackDirectory("./datapack/zones", false);
		parseDatapackDirectory("./datapack/zones/npcSpawnTerritories", false);
