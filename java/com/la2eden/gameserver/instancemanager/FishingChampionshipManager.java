...
public class FishingChampionshipManager
{
		...
		for (Fisher fisher : _winPlayers)
		{
			if (fisher.getName().equalsIgnoreCase(pl.getName()) && (fisher.getRewardType() != 2))
			{
				...
				if (rewardCnt > 0)
				{
					...
					html.setFile(pl.getHtmlPrefix(), "./datapack/html/fisherman/championship/fish_event_reward001.htm");
					pl.sendPacket(html);
				}
			}
		}
	...
	public void showMidResult(L2PcInstance pl)
	{
		...
		if (_needRefresh)
		{
			html.setFile(pl.getHtmlPrefix(), "./datapack/html/fisherman/championship/fish_event003.htm");
			pl.sendPacket(html);
		...
		html.setFile(pl.getHtmlPrefix(), "./datapack/html/fisherman/championship/fish_event002.htm");
	...
	{
		final NpcHtmlMessage html = new NpcHtmlMessage();
		html.setFile(pl.getHtmlPrefix(), "./datapack/html/fisherman/championship/fish_event001.htm");
