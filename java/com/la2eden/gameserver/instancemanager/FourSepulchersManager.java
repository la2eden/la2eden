...
import com.la2eden.gameserver.instancemanager.tasks.FourSepulchersChangeAttackTimeTask;
import com.la2eden.gameserver.instancemanager.tasks.FourSepulchersChangeCoolDownTimeTask;
import com.la2eden.gameserver.instancemanager.tasks.FourSepulchersChangeEntryTimeTask;
import com.la2eden.gameserver.instancemanager.tasks.FourSepulchersChangeWarmUpTimeTask;
...
import com.la2eden.gameserver.model.actor.instance.L2SepulcherMonsterInstance;
import com.la2eden.gameserver.model.actor.instance.L2SepulcherNpcInstance;
...
public final class FourSepulchersManager
{
	...
	public void showHtmlFile(L2PcInstance player, String file, L2Npc npc, L2PcInstance member)
	{
		...
		html.setFile(player.getHtmlPrefix(), "./datapack/html/SepulcherNpc/" + file);
		if (member != null)
		{
