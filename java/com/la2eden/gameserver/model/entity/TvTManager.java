...
public class TvTManager
{
	...
	protected TvTManager()
	{
		if (Config.TVT_EVENT_ENABLED)
		{
			...
			scheduleEventStart();
			_log.info("TvTManager: Engine started.");
		}
		else
		{
			_log.info("TvTManager: Engine is disabled.");
		}
	}
	...
	public void scheduleEventStart()
	{
		...
		{
			_log.warning("TvTManager: Error figuring out a start time. Check TvTEventInterval in config file.");
		}
	}
	...
	public void startReg()
	{
		if (!TvTEvent.startParticipation())
		{
			...
			_log.warning("TvTManager: Error spawning event npc for participation.");
	...
	public void startEvent()
	{
		if (!TvTEvent.startFight())
		{
			...
			_log.info("TvTManager: Lack of participants, event aborted.");
