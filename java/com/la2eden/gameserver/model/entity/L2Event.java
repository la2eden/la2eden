	...
	public static void showEventHtml(L2PcInstance player, String objectid)
	{
		...
		if (eventState == EventState.STANDBY)
		{
			try
			{
				...
				{
					htmContent = HtmCache.getInstance().getHtm(player.getHtmlPrefix(), "./datapack/html/mods/EventEngine/Participating.htm");
				}
				else
				{
					htmContent = HtmCache.getInstance().getHtm(player.getHtmlPrefix(), "./datapack/html/mods/EventEngine/Participation.htm");
				}
