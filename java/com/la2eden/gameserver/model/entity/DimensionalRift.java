...
public class DimensionalRift
{
	...
	public void manualTeleport(L2PcInstance player, L2Npc npc)
	{
		...
		{
			DimensionalRiftManager.getInstance().showHtmlFile(player, "./datapack/html/seven_signs/rift/NotPartyLeader.htm", npc);
			return;
		}
		
		if (_hasJumped)
		{
			DimensionalRiftManager.getInstance().showHtmlFile(player, "./datapack/html/seven_signs/rift/AlreadyTeleported.htm", npc);
			return;
		}
