...
import com.la2eden.gameserver.enums.QuestType;
...
import com.la2eden.gameserver.network.serverpackets.ExShowQuestMark;
...
import com.la2eden.gameserver.network.serverpackets.TutorialEnableClientEvent;
...
public final class QuestState
{
	 ...
	 * @see com.la2eden.gameserver.model.quest.State
	 */
	...
	{
		String text = HtmCache.getInstance().getHtm(_player.getHtmlPrefix(), "./datapack/scripts/quests/Q00255_Tutorial/" + html);
		if (text == null)
		{
