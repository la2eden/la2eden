 ...
 */
package com.la2eden.gameserver.model.stats.functions;

import java.lang.reflect.Constructor;
import java.util.logging.Logger;

import com.la2eden.gameserver.enums.StatFunction;
...
public final class FuncTemplate
{
	...
	public FuncTemplate(Condition attachCond, Condition applayCond, String functionName, int order, Stats stat, double value)
	{
		...
		try
		{
			final Class<?> functionClass = Class.forName("com.la2eden.gameserver.model.stats.functions.Func" + function.getName());
