 ...
 */
package com.la2eden.gameserver.model.actor;
...
import com.la2eden.gameserver.ai.L2AttackableAI;
import com.la2eden.gameserver.ai.L2CharacterAI;
import com.la2eden.gameserver.data.xml.impl.CategoryData;
...
import com.la2eden.gameserver.model.CharEffectList;
...
import com.la2eden.gameserver.model.actor.knownlist.CharKnownList;
import com.la2eden.gameserver.model.actor.stat.CharStat;
import com.la2eden.gameserver.model.actor.status.CharStatus;
import com.la2eden.gameserver.model.actor.tasks.character.FlyToLocationTask;
import com.la2eden.gameserver.model.actor.tasks.character.HitTask;
import com.la2eden.gameserver.model.actor.tasks.character.MagicUseTask;
import com.la2eden.gameserver.model.actor.tasks.character.NotifyAITask;
import com.la2eden.gameserver.model.actor.tasks.character.QueuedMagicUseTask;
...
import com.la2eden.gameserver.model.actor.transform.TransformTemplate;
...
import com.la2eden.gameserver.model.events.Containers;
...
import com.la2eden.gameserver.model.holders.InvulSkillHolder;
import com.la2eden.gameserver.model.holders.SkillHolder;
import com.la2eden.gameserver.model.holders.SkillUseHolder;
import com.la2eden.gameserver.model.interfaces.IDeletable;
import com.la2eden.gameserver.model.interfaces.ILocational;
import com.la2eden.gameserver.model.interfaces.ISkillsHolder;
...
import com.la2eden.gameserver.model.options.OptionsSkillHolder;
import com.la2eden.gameserver.model.options.OptionsSkillType;
import com.la2eden.gameserver.model.skills.AbnormalType;
import com.la2eden.gameserver.model.skills.AbnormalVisualEffect;
...
import com.la2eden.gameserver.model.skills.SkillChannelized;
import com.la2eden.gameserver.model.skills.SkillChannelizer;
import com.la2eden.gameserver.model.skills.targets.L2TargetType;
import com.la2eden.gameserver.model.stats.BaseStats;
import com.la2eden.gameserver.model.stats.Calculator;
...
import com.la2eden.gameserver.network.serverpackets.Attack;
import com.la2eden.gameserver.network.serverpackets.ChangeMoveType;
...
import com.la2eden.gameserver.network.serverpackets.MagicSkillCanceld;
import com.la2eden.gameserver.network.serverpackets.MagicSkillLaunched;
import com.la2eden.gameserver.network.serverpackets.MagicSkillUse;
import com.la2eden.gameserver.network.serverpackets.MoveToLocation;
import com.la2eden.gameserver.network.serverpackets.Revive;
...
import com.la2eden.gameserver.network.serverpackets.TeleportToLocation;
import com.la2eden.gameserver.pathfinding.AbstractNodeLoc;
...
import com.la2eden.util.EmptyQueue;
