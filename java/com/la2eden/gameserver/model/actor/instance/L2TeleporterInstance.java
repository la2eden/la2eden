...
import com.la2eden.gameserver.instancemanager.TownManager;
...
public final class L2TeleporterInstance extends L2Npc
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		if (player.isAffectedBySkill(6201) || player.isAffectedBySkill(6202) || player.isAffectedBySkill(6203))
		{
			...
			final String filename = "./datapack/html/teleporter/epictransformed.htm";
	...
	public String getHtmlPath(int npcId, int val)
	{
		...
		return "./datapack/html/teleporter/" + pom + ".htm";
	}
	...
	private void showNewbieHtml(L2PcInstance player)
	{
		...
		String filename = "./datapack/html/teleporter/free/" + getTemplate().getId() + ".htm";
		if (!HtmCache.getInstance().isLoadable(filename))
		{
			filename = "./datapack/html/teleporter/" + getTemplate().getId() + "-1.htm";
		}
	...
	private void showHalfPriceHtml(L2PcInstance player)
	{
		...
		String filename = "./datapack/html/teleporter/half/" + getId() + ".htm";
		if (!HtmCache.getInstance().isLoadable(filename))
		{
			filename = "./datapack/html/teleporter/" + getId() + "-1.htm";
		}
	...
	{
		String filename = "./datapack/html/teleporter/castleteleporter-no.htm";
		...
		else if (condition > COND_ALL_FALSE)
		{
			...
			{
				filename = "./datapack/html/teleporter/castleteleporter-busy.htm"; // Busy because of siege
			}
	...
	private void doTeleport(L2PcInstance player, int val)
	{
		...
		if (list != null)
		{
			...
			{
				final String filename = "./datapack/html/teleporter/nobleteleporter-no.htm";
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.getHtmlPrefix(), filename);
				html.replace("%objectId%", String.valueOf(getObjectId()));
				html.replace("%npcname%", getName());
