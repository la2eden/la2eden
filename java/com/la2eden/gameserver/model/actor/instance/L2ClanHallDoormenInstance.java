...
import com.la2eden.gameserver.util.Evolve;
...
public class L2ClanHallDoormenInstance extends L2DoormenInstance
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		if (_hasEvolve && command.startsWith("evolve"))
		{
			if (isOwnerClan(player))
			{
				...
				if (ok)
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/evolve-ok.htm");
				}
				else
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/evolve-no.htm");
				}
	...
	public void showChatWindow(L2PcInstance player)
	{
		...
		if (getClanHall() != null)
		{
			...
			if (isOwnerClan(player))
			{
				if (_hasEvolve)
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/doormen2.htm");
					html.replace("%clanname%", owner.getName());
				}
				else
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/doormen1.htm");
					html.replace("%clanname%", owner.getName());
				}
			}
			else
			{
				...
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/doormen-no.htm");
					html.replace("%leadername%", owner.getLeaderName());
					html.replace("%clanname%", owner.getName());
				}
				else
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/emptyowner.htm");
	...
	protected final void openDoors(L2PcInstance player, String command)
	{
		...
		final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
		html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/doormen-opened.htm");
		html.replace("%objectId%", String.valueOf(getObjectId()));
		player.sendPacket(html);
	}
	...
	protected final void closeDoors(L2PcInstance player, String command)
	{
		...
		final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
		html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallDoormen/doormen-closed.htm");
		html.replace("%objectId%", String.valueOf(getObjectId()));
		player.sendPacket(html);
	}
