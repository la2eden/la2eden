...
public class L2NpcBufferInstance extends L2Npc
{
	...
	public void showChatWindow(L2PcInstance player, int val)
	{
		...
		String htmContent = HtmCache.getInstance().getHtm(player.getHtmlPrefix(), "./datapack/html/mods/NpcBuffer.htm");
		if (val > 0)
		{
			htmContent = HtmCache.getInstance().getHtm(player.getHtmlPrefix(), "./datapack/html/mods/NpcBuffer-" + val + ".htm");
		}
