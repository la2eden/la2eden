...
import com.la2eden.gameserver.instancemanager.ClanHallAuctionManager;
...
import com.la2eden.gameserver.model.entity.Auction;
import com.la2eden.gameserver.model.entity.Auction.Bidder;
...
public final class L2AuctioneerInstance extends L2Npc
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		{
			final String filename = "./datapack/html/auction/auction-busy.htm";
		...
		else if (condition == COND_REGULAR)
		{
			...
			if (actualCommand.equalsIgnoreCase("auction"))
			{
				...
				try
				{
					...
					try
					{
						...
						final String filename = "./datapack/html/auction/AgitSale3.htm";
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), filename);
						html.replace("%x%", val);
			...
			else if (actualCommand.equalsIgnoreCase("bidding"))
			{
				...
				try
				{
					...
					final String filename = "./datapack/html/auction/AgitAuctionInfo.htm";
			...
			else if (actualCommand.equalsIgnoreCase("bid1"))
			{
				...
				try
				{
					final String filename = "./datapack/html/auction/AgitBid1.htm";
			...
			else if (actualCommand.equalsIgnoreCase("list"))
			{
				...
				items.append("</table>");
				final String filename = "./datapack/html/auction/AgitAuctionList.htm";
			...
			else if (actualCommand.equalsIgnoreCase("bidlist"))
			{
				...
				final String filename = "./datapack/html/auction/AgitBidderList.htm";
			...
			else if (actualCommand.equalsIgnoreCase("selectedItems"))
			{
				...
				{
					final SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm");
					final String filename = "./datapack/html/auction/AgitBidInfo.htm";
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), filename);
				...
				{
					final SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm");
					final String filename = "./datapack/html/auction/AgitSaleInfo.htm";
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), filename);
				...
				else if ((player.getClan() != null) && (player.getClan().getHideoutId() != 0))
				{
					...
					final String filename = "./datapack/html/auction/AgitInfo.htm";
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), filename);
			...
			else if (actualCommand.equalsIgnoreCase("cancelBid"))
			{
				...
				final String filename = "./datapack/html/auction/AgitBidCancel.htm";
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.getHtmlPrefix(), filename);
			...
			else if (actualCommand.equalsIgnoreCase("cancelAuction"))
			{
				...
				{
					final String filename = "./datapack/html/auction/not_authorized.htm";
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), filename);
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				...
				final String filename = "./datapack/html/auction/AgitSaleCancel.htm";
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.getHtmlPrefix(), filename);
			...
			{
				final String filename = "./datapack/html/auction/AgitSale2.htm";
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.getHtmlPrefix(), filename);
			...
			else if (actualCommand.equalsIgnoreCase("sale"))
			{
				...
				final String filename = "./datapack/html/auction/AgitSale1.htm";
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.getHtmlPrefix(), filename);
				html.replace("%AGIT_DEPOSIT%", String.valueOf(ClanHallManager.getInstance().getClanHallByOwner(player.getClan()).getLease()));
			...
			else if (actualCommand.equalsIgnoreCase("rebid"))
			{
				...
				try
				{
					final String filename = "./datapack/html/auction/AgitBid2.htm";
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), filename);
					final Auction a = ClanHallAuctionManager.getInstance().getAuction(player.getClan().getAuctionBiddedAt());
					if (a != null)
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.getHtmlPrefix(), "./datapack/html/auction/location.htm");
	...
	{
		String filename = "./datapack/html/auction/auction-no.htm";
		
		final int condition = validateCondition(player);
		if (condition == COND_BUSY_BECAUSE_OF_SIEGE)
		{
			filename = "./datapack/html/auction/auction-busy.htm"; // Busy because of siege
		}
		else
		{
			filename = "./datapack/html/auction/auction.htm";
		}
