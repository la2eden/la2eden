...
import com.la2eden.gameserver.network.serverpackets.SortedWareHouseWithdrawalList;
import com.la2eden.gameserver.network.serverpackets.SortedWareHouseWithdrawalList.WarehouseListType;
import com.la2eden.gameserver.network.serverpackets.WareHouseDepositList;
import com.la2eden.gameserver.network.serverpackets.WareHouseWithdrawalList;
...
public class L2FortManagerInstance extends L2MerchantInstance
{
		...
		else if (condition == COND_OWNER)
		{
			...
			if (actualCommand.equalsIgnoreCase("expel"))
			{
				if (player.hasClanPrivilege(ClanPrivilege.CS_DISMISS))
				{
					...
					html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-expel.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				}
				else
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-noprivs.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				}
				return;
			...
			else if (actualCommand.equalsIgnoreCase("banish_foreigner"))
			{
				if (player.hasClanPrivilege(ClanPrivilege.CS_DISMISS))
				{
					...
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-expeled.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				}
				else
			...
			else if (actualCommand.equalsIgnoreCase("receive_report"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-report.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-castlereport.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					int hour, minutes;
					if (Config.FS_MAX_OWN_TIME > 0)
					{
			...
			// control
			{
				if (player.hasClanPrivilege(ClanPrivilege.CS_OPEN_DOOR))
				{
					if (!val.isEmpty())
					{
						...
						{
							final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
							html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-opened.htm");
							html.replace("%objectId%", String.valueOf(getObjectId()));
							player.sendPacket(html);
						}
						else
						{
							final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
							html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-closed.htm");
							html.replace("%objectId%", String.valueOf(getObjectId()));
							player.sendPacket(html);
						}
					}
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/" + getTemplate().getId() + "-d.htm");
						html.replace("%objectId%", String.valueOf(getObjectId()));
			...
			else if (actualCommand.equalsIgnoreCase("manage_vault"))
			{
				...
				if (player.hasClanPrivilege(ClanPrivilege.CL_VIEW_WAREHOUSE))
				{
					...
					else if (val.equalsIgnoreCase("withdraw"))
					{
						...
						{
							final String htmFile = "./datapack/html/mods/WhSortedC.htm";
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-vault.htm");
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				if (val.equalsIgnoreCase("tele"))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-nac.htm");
					}
					else
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/" + getId() + "-t" + getFort().getFunction(Fort.FUNC_TELEPORT).getLvl() + ".htm");
					}
					sendHtmlMessage(player, html);
				}
				else if (val.equalsIgnoreCase("support"))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/support" + getFort().getFunction(Fort.FUNC_SUPPORT).getLvl() + ".htm");
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/foreman-functions.htm");
				...
				if (player.hasClanPrivilege(ClanPrivilege.CS_SET_FUNCTIONS))
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							{
								final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
								html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/functions-cancel.htm");
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								val = st.nextToken();
								final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
								html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/functions-apply.htm");
							...
							else if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									val = st.nextToken();
									final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
									html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/functions-apply_confirmed.htm");
									if (getFort().getFunction(Fort.FUNC_RESTORE_HP) != null)
									{
										if (getFort().getFunction(Fort.FUNC_RESTORE_HP).getLvl() == Integer.parseInt(val))
										{
											html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/functions-used.htm");
									...
									switch (percent)
									{
										case 0:
											fee = 0;
											html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/functions-cancel_confirmed.htm");
											break;
										case 300:
									...
									{
										html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/low_adena.htm");
										sendHtmlMessage(player, html);
									}
									sendHtmlMessage(player, html);
								}
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/edit_recovery.htm");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/edit_other.htm");
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/manage.htm");
						sendHtmlMessage(player, html);
					}
				}
				else
				...
				try
				{
					...
					try
					{
						...
						else
						{
							...
							{
								html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/support-no_mana.htm");
								html.replace("%mp%", String.valueOf((int) getCurrentMp()));
								sendHtmlMessage(player, html);
								return;
							}
						}
						html.setFile(player.getHtmlPrefix(), "./datapack/html/fortress/support-done.htm");
						html.replace("%mp%", String.valueOf((int) getCurrentMp()));
						sendHtmlMessage(player, html);
					}
					catch (Exception e)
	...
	public void showChatWindow(L2PcInstance player)
	{
		...
		String filename = "./datapack/html/fortress/foreman-no.htm";
		...
		if (condition > COND_ALL_FALSE)
		{
			...
			{
				filename = "./datapack/html/fortress/foreman-busy.htm"; // Busy because of siege
			}
			else if (condition == COND_OWNER)
			{
				filename = "./datapack/html/fortress/foreman.htm"; // Owner message window
			}
		}
