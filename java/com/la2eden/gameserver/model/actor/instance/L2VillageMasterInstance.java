...
import com.la2eden.gameserver.model.L2Clan.SubPledge;
...
import com.la2eden.gameserver.model.base.AcquireSkillType;
...
import com.la2eden.gameserver.network.serverpackets.AcquireSkillList;
...
public class L2VillageMasterInstance extends L2NpcInstance
{
	...
	public String getHtmlPath(int npcId, int val)
	{
		...
		return "./datapack/html/villagemaster/" + pom + ".htm";
	}
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("change_clan_leader"))
		{
			...
			else
			{
				...
				if (clan.getNewLeaderId() == 0)
				{
					...
					msg.setFile(player.getHtmlPrefix(), "./datapack/scripts/village_master/Clan/9000-07-success.htm");
				}
				else
				{
					msg.setFile(player.getHtmlPrefix(), "./datapack/scripts/village_master/Clan/9000-07-in-progress.htm");
				}
		...
		else if (actualCommand.equalsIgnoreCase("cancel_clan_leader_change"))
		{
			...
			if (clan.getNewLeaderId() != 0)
			{
				...
				msg.setFile(player.getHtmlPrefix(), "./datapack/scripts/village_master/Clan/9000-07-canceled.htm");
			}
			else
			{
		...
		else if (command.startsWith("Subclass"))
		{
			...
			{
				html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_NoTransformed.htm");
			...
			if (player.hasSummon())
			{
				html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_NoSummon.htm");
				player.sendPacket(html);
				return;
			}
			...
			switch (cmdChoice)
			{
				...
				case 1: // Add Subclass - Initial
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_Add.htm");
					...
					else
					{
						...
						{
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_Fail_Elves.htm");
							player.sendPacket(html);
						}
						else if (player.getRace() == Race.KAMAEL)
						{
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_Fail_Kamael.htm");
							player.sendPacket(html);
						}
						else
						{
				...
				case 2: // Change Class - Initial
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ChangeNo.htm");
					}
					else
					{
						...
						{
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_Change.htm");
							html.replace("%list%", content2.toString());
						}
						else
						{
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ChangeNotFound.htm");
						}
					}
					break;
				case 3: // Change/Cancel Subclass - Initial
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyEmpty.htm");
						break;
					}
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyCustom.htm");
					...
					else
					{
						...
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_Modify.htm");
				...
				case 4: // Add Subclass - Action (Subclass 4 x[x])
					...
					if (allowAddition && isValidNewSubClass(player, paramOne))
					{
						...
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_AddOk.htm");
				...
				case 5: // Change Class - Action
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_Current.htm");
						break;
					}
				...
				case 6: // Change/Cancel Subclass - Choice
					...
					{
						case 1:
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyChoice1.htm");
							break;
						case 2:
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyChoice2.htm");
							break;
						case 3:
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyChoice3.htm");
							break;
						default:
							html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyChoice.htm");
					}
				...
				case 7: // Change Subclass - Action
					...
					if (player.modifySubClass(paramOne, paramTwo))
					{
						...
						html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/SubClass_ModifyOk.htm");
	...
	protected String getSubClassMenu(Race race)
	{
		...
		return "./datapack/html/villagemaster/SubClass_NoOther.htm";
	}
	
	protected String getSubClassFail()
	{
		return "./datapack/html/villagemaster/SubClass_Fail.htm";
	}
	...
	public static final void showPledgeSkillList(L2PcInstance player)
	{
		if (!player.isClanLeader())
		{
			...
			html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/NotClanLeader.htm");
			player.sendPacket(html);
		...
		if (counts == 0)
		{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage();
				html.setFile(player.getHtmlPrefix(), "./datapack/html/villagemaster/NoMoreSkills.htm");
				player.sendPacket(html);
			}
		}
		else
