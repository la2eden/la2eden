...
import com.la2eden.gameserver.model.L2TeleportLocation;
...
import com.la2eden.gameserver.model.entity.ClanHall;
...
import com.la2eden.gameserver.network.serverpackets.AgitDecoInfo;
...
public class L2ClanHallManagerInstance extends L2MerchantInstance
{
		...
		if (condition == COND_OWNER)
		{
			...
			if (actualCommand.equalsIgnoreCase("banish_foreigner"))
			{
				...
				if (player.hasClanPrivilege(ClanPrivilege.CH_DISMISS))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/banish-list.htm");
					}
					else if (val.equalsIgnoreCase("banish"))
					{
						getClanHall().banishForeigners();
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/banish.htm");
					}
				}
				else
				{
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/not_authorized.htm");
				}
			...
			else if (actualCommand.equalsIgnoreCase("manage_vault"))
			{
				...
				if (player.hasClanPrivilege(ClanPrivilege.CL_VIEW_WAREHOUSE))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/vault-chs.htm");
					}
					else
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/vault.htm");
			...
			else if (actualCommand.equalsIgnoreCase("door"))
			{
				...
				if (player.hasClanPrivilege(ClanPrivilege.CH_OPEN_DOOR))
				{
					if (val.equalsIgnoreCase("open"))
					{
						...
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/door-open.htm");
					}
					else if (val.equalsIgnoreCase("close"))
					{
						getClanHall().openCloseDoors(false);
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/door-close.htm");
					}
					else
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/door.htm");
					}
					sendHtmlMessage(player, html);
				}
				else
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				if (val.equalsIgnoreCase("tele"))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/chamberlain-nac.htm");
					}
					else
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/tele" + getClanHall().getLocation() + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
					}
					sendHtmlMessage(player, html);
				}
				...
				else if (val.equalsIgnoreCase("support"))
				{
					...
					{
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/support" + getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() + ".htm");
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/functions.htm");
				...
				if (player.hasClanPrivilege(ClanPrivilege.CH_SET_FUNCTIONS))
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							{
								final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
								html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/functions-cancel.htm");
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								val = st.nextToken();
								final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
								html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/functions-apply.htm");
							...
							else if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									val = st.nextToken();
									final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
									html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/functions-apply_confirmed.htm");
									if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null)
									{
										if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP).getLvl() == Integer.parseInt(val))
										{
											html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/functions-used.htm");
									...
									switch (percent)
									{
										case 0:
											fee = 0;
											html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/functions-cancel_confirmed.htm");
											break;
										case 20:
									...
									{
										html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/low_adena.htm");
										sendHtmlMessage(player, html);
									}
									else
									{
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/edit_recovery.htm");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/edit_other.htm");
					...
					else if (val.equalsIgnoreCase("deco") && !getClanHall().isSiegableHall())
					{
						...
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/deco.htm");
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getHtmlPrefix(), getClanHall().isSiegableHall() ? "./datapack/html/clanHallManager/manage_siegable.htm" : "./datapack/html/clanHallManager/manage.htm");
						sendHtmlMessage(player, html);
					}
				}
				else
				...
				try
				{
					...
					try
					{
						...
						else
						{
							...
							{
								final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
								html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/support-no_mana.htm");
								html.replace("%mp%", String.valueOf((int) getCurrentMp()));
								sendHtmlMessage(player, html);
								return;
							}
						...
						html.setFile(player.getHtmlPrefix(), "./datapack/html/clanHallManager/support-done.htm");
						html.replace("%mp%", String.valueOf((int) getCurrentMp()));
						sendHtmlMessage(player, html);
					}
					catch (Exception e)
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				String file = "./datapack/html/clanHallManager/chamberlain-" + getId() + ".htm";
				if (!HtmCache.getInstance().isLoadable(file))
				{
					file = "./datapack/html/clanHallManager/chamberlain.htm";
				}
	...
	public void showChatWindow(L2PcInstance player)
	{
		...
		String filename = "./datapack/html/clanHallManager/chamberlain-no.htm";
		
		final int condition = validateCondition(player);
		if (condition == COND_OWNER)
		{
			filename = "./datapack/html/clanHallManager/chamberlain-" + getId() + ".htm";
			if (!HtmCache.getInstance().isLoadable(filename))
			{
				filename = "./datapack/html/clanHallManager/chamberlain.htm";// Owner message window
			}
		}
		else if (condition == COND_OWNER_FALSE)
		{
			filename = "./datapack/html/clanHallManager/chamberlain-of.htm";
		}
		final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
