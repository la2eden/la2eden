...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (showClanNotice)
		{
			...
			notice.setFile(activeChar.getHtmlPrefix(), "./datapack/html/clanNotice.htm");
		...
		{
			final String serverNews = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "./datapack/html/servnews.htm");
			if (serverNews != null)
			{
	...
	private void sendServerVersion(L2PcInstance chr)
	{
		...
		chr.sendMessage("Build number: .. " + Config.BUILD_VERSION);
