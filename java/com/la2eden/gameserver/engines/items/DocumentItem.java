 ...
 */
package com.la2eden.gameserver.engines.items;
...
import com.la2eden.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			final Constructor<?> itemClass = Class.forName("com.la2eden.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
