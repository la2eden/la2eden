...
import com.la2eden.gameserver.model.holders.RangeChanceHolder;
import com.la2eden.gameserver.model.items.L2Item;
import com.la2eden.gameserver.model.items.enchant.EnchantItemGroup;
import com.la2eden.gameserver.model.items.enchant.EnchantRateItem;
import com.la2eden.gameserver.model.items.enchant.EnchantScrollGroup;
...
public final class EnchantItemGroupsData implements IXmlReader
{
	...
	public synchronized void load()
	{
		_itemGroups.clear();
		_scrollGroups.clear();
		parseDatapackFile("./datapack/EnchantItemGroups.xml");
