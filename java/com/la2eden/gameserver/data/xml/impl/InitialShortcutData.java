...
import com.la2eden.gameserver.enums.MacroType;
import com.la2eden.gameserver.enums.ShortcutType;
import com.la2eden.gameserver.model.Macro;
import com.la2eden.gameserver.model.MacroCmd;
...
import com.la2eden.gameserver.network.serverpackets.ShortCutRegister;
...
public final class InitialShortcutData implements IXmlReader
{
	...
	public void load()
	{
		...
		parseDatapackFile("./datapack/stats/initialShortcuts.xml");
