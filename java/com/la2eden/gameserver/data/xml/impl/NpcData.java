...
import com.la2eden.gameserver.enums.AISkillScope;
...
import com.la2eden.gameserver.model.holders.MinionHolder;
...
public class NpcData implements IXmlReader
{
	...
	public synchronized void load()
	{
		...
		parseDatapackDirectory("./datapack/stats/npcs", false);
		LOGGER.info(getClass().getSimpleName() + ": Loaded " + _npcs.size() + " NPCs.");
		
		if (Config.CUSTOM_NPC_DATA)
		{
			final int npcCount = _npcs.size();
			parseDatapackDirectory("./datapack/stats/npcs/custom", true);
	...
	private final class MinionData implements IXmlReader
	{
		...
		{
			_tempMinions.clear();
			parseDatapackFile("./datapack/MinionData.xml");
