...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see com.la2eden.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link com.la2eden.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see com.la2eden.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see com.la2eden.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see com.la2eden.util.Rnd#get(int n)
	 */
